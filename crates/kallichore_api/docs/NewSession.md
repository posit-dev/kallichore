...
**frontend_id** | **String** | The MCP frontend creating the session, if the client has registered one. The session belongs to that frontend: agents reach it through that frontend's MCP endpoint and no other. | [optional] [default to None]
