...
**resource_include_children** | **bool** | Whether the resource usage reported for a session includes the usage of its child processes. When false, only the session's own process is measured. | [optional] [default to None]
